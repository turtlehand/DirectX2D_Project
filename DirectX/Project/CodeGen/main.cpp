...
int main()
{
	...
	wstring strScriptCode = strScriptIncludePath + L"Practice\\Scripts\\";
	...
	fwprintf_s(pFile, L"class GScript;\n\n");

	fwprintf_s(pFile, L"class GScriptManager\n{\n");
	fwprintf_s(pFile, L"public:\n\tstatic void GetScriptInfo(vector<wstring>& _vec);\n");
	fwprintf_s(pFile, L"\tstatic GScript * GetScript(const wstring& _strScriptName);\n");
	fwprintf_s(pFile, L"\tstatic GScript * GetScript(UINT _iScriptType);\n");
	fwprintf_s(pFile, L"\tstatic const wchar_t * GetScriptName(GScript * _pScript);\n};\n");
	...
	fwprintf_s(pFile, L"#include \"GScriptManager.h\"\n\n");
	...
	// 두번째 함수 작성
	fwprintf_s(pFile, L"GScript * GScriptManager::GetScript(const wstring& _strScriptName)\n{\n");
	...
	// 세번째 함수
	fwprintf_s(pFile, L"GScript * GScriptManager::GetScript(UINT _iScriptType)\n{\n");
	...
	// 네번째 함수
	fwprintf_s(pFile, L"const wchar_t * GScriptManager::GetScriptName(GScript * _pScript)\n{\n");
